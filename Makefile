#############################################################################
# Makefile for building: testglyuv
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = testglyuv1.0.0
DISTDIR = /home/show/workspace/rockpi4b/testglyuv/.tmp/testglyuv1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		test.pro glwidget.h main.cpp \
		glwidget.cpp
QMAKE_TARGET  = testglyuv
DESTDIR       = 
TARGET        = testglyuv
